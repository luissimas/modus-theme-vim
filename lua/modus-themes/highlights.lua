...
function M.core_highlights(colors)
	...
	syntax["SpellBad"] = { fg = colors.fg_main, style = "undercurl" }
	syntax["SpellCap"] = { fg = colors.fg_main, style = "undercurl" }
	-- syntax['SpellLocal'] = {}
	-- syntax['SpellRare'] = {}
